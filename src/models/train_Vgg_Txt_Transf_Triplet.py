...
from src.models.models import VGGpre_SingleTextModel
...
def main(data_path, n_epochs=20, batch_size=32, seed=0, lr=1e-4):
    ...
    save_model_path = save_path / "Vgg_Text_Transf_Triplet.pt"
    save_model_full_path = save_path / "Vgg_Text_Transf_Triplet_full.pt"
